            ...
            <div className="container mx-auto">
                ...
                >
                    <div className="bg-white/10 group hover:bg-white/20 p-4 rounded-lg transition-all duration-300">
                        <Image src={martin} width={500} height={500} alt='martin' className='w-60 h-auto rounded-2xl' />
                    ...
                    <div className="bg-white/10 group hover:bg-white/20 p-4 rounded-lg transition-all duration-300">
                        <Image src={austin} width={500} height={500} className='w-60 h-auto rounded-2xl' />
